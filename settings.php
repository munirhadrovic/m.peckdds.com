<?php
	$adresa="8251 Cornell Road Suite 130 Cincinnati, OH 45249"; //jako je vazno navesti dobro adresu radi boljeg poziciniranja
	$grad="";//jako je vazno ako adresa ima dva imena povezati ih sa plus
	$skracenica=""; // AKo ne znate skracenicu ostavite praznu
	$telephone=5136217666;// Broj koji se poziva na dugme CALL US
